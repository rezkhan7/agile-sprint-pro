    ...
    <div className={sidebarClassNames}>
        ...
        {/* Navbar Links*/}
            ...
            <button onClick={()=> setShowProjects((prev) => !prev)}
             className='flex w-full items-center justify-between px-3 py-3 text-gray-500'>
            ...
            </button>
            {
                showPriority && (
                    <>
                        ...
                        <SidebarLink icon= {AlertOctagon} label="Low" href = '/teams/low' />
                        <SidebarLink icon= {Layers3} label="Backlog" href = '/teams/backlog' />
                    </>
                )
            }
        </div>  
